...
export function renderValuationReportHtml(packet:ReportPacket):string{
  const title=packet.reportType==='diminished_value'?'Diminished Value Report':packet.reportType==='acv'?'Actual Cash Value Report':'Fair Market Value Report';
