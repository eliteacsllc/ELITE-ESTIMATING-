...
test('creates human-review demand draft from governed valuation revision',()=>{
  const revision=createValuationRevision({kind:'market_value',createdBy:'appraiser@example.com',reason:'carrier_counter',result:{indicatedValue:32500,confidence:91}});
