...
const DEFINITIONS: Partial<Record<FeatureId, FeatureHarmonyDefinition>> = {
  ...
  fraud_anomaly: { lane: 'audit_compliance', priority: 70, criticality: 'important', mutationClass: 'recommendation', meshCapability: 'audit', providerCapabilities: [] },
  ...
  carrier_compliance: { lane: 'audit_compliance', priority: 90, criticality: 'important', mutationClass: 'approval_sensitive', meshCapability: 'audit', providerCapabilities: [] },
