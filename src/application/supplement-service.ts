...
export class SupplementService {
  constructor(private readonly estimates: EstimateRepository, private readonly supplements: SupplementRepository) {}
  ...
  async create(principal: Principal, estimateId: string): Promise<Supplement> {
    ...
    return this.supplements.create(principal.tenantId, createSupplement(estimate));
  }
  ...
  async addChange(principal: Principal, supplementId: string, input: AddSupplementChangeInput): Promise<Supplement> {
    ...
    return this.supplements.save(principal.tenantId, { ...supplement, changes: [...supplement.changes, change] });
  }
  ...
  async submit(principal: Principal, supplementId: string): Promise<Supplement> {
    ...
    return this.supplements.save(principal.tenantId, { ...supplement, status: 'submitted' });
  }
