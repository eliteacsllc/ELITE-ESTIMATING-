...
const FEATURES = new Set<FeatureId>(['collision','property','commercial_truck','heavy_equipment','powersports','rv','marine','contents','specialty','super_appraiser','damage_ai','vin_build','oem_procedures','motor_raced','deg_intelligence','icar_blueprint','parts_optimizer','labor_intelligence','adas_diagnostics','repair_replace','total_loss','market_comps','salvage','fraud_anomaly','estimate_audit','supplements','carrier_compliance','screen_copilot','collaboration','analytics','api_access']);
