...
export const DOMAIN_ADAPTERS: ReadonlyArray<EstimatingDomainAdapter> = [
  new StaticDomainAdapter('collision', ['passenger_vehicle','commercial_vehicle','ambulance_emergency'], vehicleOps,
    ['asset_identity','build_configuration','parts','labor_times','materials','oem_procedures','adas_requirements','diagnostics','market_pricing','valuation'],
  ...
  new StaticDomainAdapter('commercial_truck', ['commercial_vehicle','tractor_trailer','ambulance_emergency'], vehicleOps,
    ['asset_identity','build_configuration','parts','labor_times','labor_rates','materials','oem_procedures','diagnostics','market_pricing','valuation'],
  ...
  new StaticDomainAdapter('powersports', ['motorcycle','atv_utv'], vehicleOps,
    ['asset_identity','build_configuration','parts','labor_times','materials','oem_procedures','diagnostics','market_pricing','valuation'],
  ...
  new StaticDomainAdapter('rv', ['rv'], [...vehicleOps,'install','detach_reset'],
    ['asset_identity','build_configuration','parts','labor_times','labor_rates','materials','oem_procedures','diagnostics','property_pricing','market_pricing','valuation'],
